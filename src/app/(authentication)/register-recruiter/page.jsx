    ...
    <div className="flex justify-center items-center custom-container min-h-[550px]">
      <div className="flex flex-col p-3 rounded-md sm:p-10 bg-white  text-black shadow-lg border my-5 w-full lg:w-[90%]">
        <div className="mb-8 flex justify-center items-center -mx-4 space-x-2 overflow-x-auto overflow-y-hidden sm:justify-center flex-nowrap">
          <a rel="noopener noreferrer" href="register-user" className="flex items-center flex-shrink-0 px-5 py-2 border-b-4">Job Seeker</a>
          <a rel="noopener noreferrer" href="register-recruiter" className={`${pathName === '/register-recruiter' && "border-b-primary"} flex items-center flex-shrink-0 px-5 py-2 border-b-4`}>Recruiter</a>
        </div>
        <form onSubmit={handleSubmit(handleRegister)} className="space-y-6">
          ...
          {errors?.acceptTerms?.message && (
              <span className="text-red-500 flex items-start md:justify-center">{errors?.acceptTerms?.message}</span>
            )}
