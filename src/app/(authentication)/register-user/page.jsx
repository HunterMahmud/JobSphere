...
const skillOptions = [
    ...
    { value: 'Bank/Non-Bank Fin. Institution', label: 'Bank/Non-Bank Fin. Institution' },
    ...
    { value: 'Media/Advertisement/Event Mgt.', label: 'Media/Advertisement/Event Mgt.' },
    ...
    { value: 'Beauty Care/ Health & Fitness', label: 'Beauty Care/ Health & Fitness' },
    { value: 'Law/ Legal', label: 'Law/ Legal' },
    { value: 'Electrician/ Construction/ Repair', label: 'Electrician/ Construction/ Repair' },
    ...
    { value: 'Agro (Plant/Animal/Fisheries)', label: 'Agro (Plant/Animal/Fisheries)' },
    { value: 'Commercial', label: 'Commercial' },
    { value: 'Company Secretary/Regulatory affairs', label: 'Company Secretary/Regulatory affairs' },
];
                ...
                >
                    ...
                    <div className='flex items-start md:justify-center gap-1'>
                        ...
                        <label for='acceptTerms' className='text-sm'>
                            By clicking 'Continue', you acknowledge that you have read and accept the <span className='font-medium'>Terms of Service</span> and <span className='font-medium'>Privacy Policy</span>.
                        </label>
                    </div>
                    {/* Submit button */}
                    <div>
