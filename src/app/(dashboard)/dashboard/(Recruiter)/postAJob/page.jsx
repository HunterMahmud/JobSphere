                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                {...register('vacancy', { required: 'Vacancy is required', valueAsNumber: true })}
                                type="number"
                                className="w-full mt-1 p-2 border rounded-lg"
                                placeholder="e.g. 3"
                            />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            {errors.locationType && <p className="text-red-500 text-sm">{errors.locationType.message}</p>}
                        </div>
                    ...
                    <div>
                        ...
                        <input
                            {...register('salaryScale', { required: 'Salary Scale is required' })}
                            type="text"
                            className="w-full mt-1 p-2 border rounded-lg"
                            placeholder="e.g. $80,000 - $100,000"
                        />
                        {errors.salaryScale && <p className="text-red-500 text-sm">{errors.salaryScale.message}</p>}
                    </div>
                    ...
                    <div>
                        <label className="block text-sm font-medium">Additional Requirements</label>
                        <textarea
                        ...
                        ></textarea>
                        {errors.additionalRequirements && <p className="text-red-500 text-sm">{errors.additionalRequirements.message}</p>}
                    </div>

                    <div>
                        <label className="block text-sm font-medium">Responsibilities</label>
                        <textarea
                            {...register('responsibility', { required: 'Responsibilities are required' })}
                            className="w-full mt-1 p-2 border rounded-lg"
                            placeholder="e.g. Details about job responsibilities"
                        ></textarea>
                        {errors.responsibility && <p className="text-red-500 text-sm">{errors.responsibility.message}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <CreatableSelect
                                    isMulti
                                    onChange={(selected) => field.onChange(selected.map(skill => skill.value))}
