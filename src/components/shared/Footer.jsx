const Footer = () => {
    return (
        <footer className="px-2 md:px-0 divide-y w-[90%] md:w-[90%] lg:w-[80%] mx-auto max-w-[1440px] font-lato pt-10">
            <div className="container flex flex-col justify-between mx-auto space-y-8 lg:flex-row lg:space-y-0 pb-4">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3">
                    ...
                    <div className="space-y-3 col-span-2 md:col-span-1 pb-5 md:pb-0">
                        ...
                        <ul className="space-y-1">
                            <li>
                                <a rel="noopener noreferrer" href="#">Helpline: +4401999999999</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Support: jobsphere@gmail.com</a>
                            </li>
            ...
            <div className="py-3 md:py-0 flex flex-col-reverse md:flex-row items-center justify-between">
                <div className="py-3 md:my-3 text-sm text-center">© 1968 Company Co. All rights reserved.</div>
