            ...
            >
                <div>
                    <div className='bg-[#4a5666] p-3 rounded-md text-center'>
                        <Link href={"/"} className="text-2xl font-bold text-white">Job<span className="text-sky-600">Sphere</span></Link>
                    </div>
                    ...
                    <div className='flex flex-col justify-between flex-1 mt-6'>
                        ...
                        <nav>
                            ...
                            <MenuItem icon={MdAssignmentAdd} label='Add a Job' address='/dashboard/addjob' />
