...
const RecentJobs = () => {
    ...
    return (
        <div>
            ...
            href={"/jobs"} >
                <button className='bg-primary  hover:bg-hover  py-3 px-6 shadow-2xl text-white font-bold  rounded-md text-sm transition-colors duration-300 ease-in-out'> View All Jobs</button>
