...
const ModalOfSecurity = ({ isOpenSecurity, closeModalSecurity }) => {
  return (
    <div>
      <Transition appear show={isOpenSecurity} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={closeModalSecurity}>
          <Transition.Child
            as={Fragment}
...
export default ModalOfSecurity;
